 ...
 *     windows below.
 *   - We show the next 7 days of availability with no lead-time buffer —
 *     clients can book any slot whose start is still in the future.
...
export const DEFAULT_WORK_HOUR_END = 20; // 20:00 local (last slot starts 19:40)
