...
const programs = [
  {
    ...
    perfectFor:
      "Building size, strength, and overall mass without the need for 1:1 coaching",
    features: [
      "Structured muscle-building program",
      "Size-focused training split",
      "Nutrition guidance for growth",
      "Progress tracking via app",
      "Partner discounts included",
      "Self-guided (no check-ins)",
    ],
  },
  {
    ...
    perfectFor:
      "Losing fat, improving conditioning, and getting lean while maintaining muscle — without needing 1:1 coaching",
    features: [
      "Structured fat-loss program",
      "Cutting-focused training split",
      "Nutrition guidance for shredding",
      "Progress tracking via app",
      "Partner discounts included",
      "Self-guided (no check-ins)",
    ],
